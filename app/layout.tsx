...
export const metadata: Metadata = {
  title: "Hunter.AI",
  description:
    "Agentes de IA humanizados, sites e presença digital para pequenos e médios negócios.",
};
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="flex min-h-full flex-col bg-ink font-body text-zinc-50">
        <a
          href="#main-content"
